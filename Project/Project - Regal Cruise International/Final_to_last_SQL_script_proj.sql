...
INSERT INTO proj_port_country (port_city, country) VALUES ('Port Stanley', 'Argentina');
...
INSERT INTO proj_port_country (port_city, country) VALUES ('Miami', 'USA');
INSERT INTO proj_port_country (port_city, country) VALUES ('Lison', 'Portugal'); 
...
INSERT INTO proj_port (port_id, port_city, docking_area) VALUES (NULL, 'Elephant Island', 'Section207');
INSERT INTO proj_port (port_id, port_city, docking_area) VALUES (NULL, 'South Shetlands Island', 'Section208'); 
...
INSERT INTO proj_port (port_id, port_city, docking_area) VALUES (NULL, 'Venice', 'Section247');
...
INSERT INTO proj_port (port_id, port_city, docking_area) VALUES (NULL, 'New London', 'Section259');
...
INSERT INTO proj_package (package_id, package_title, depart_date, arrival_date, base_price, reduced_price, ship_id) VALUES
(NULL, 'Canadian Culture Summer 2014', TO_DATE('05/05/2014', 'DD/MM/YYYY'), TO_DATE('18/06/2014', 'DD/MM/YYYY'), 3600, NULL, 23);
INSERT INTO proj_package (package_id, package_title, depart_date, arrival_date, base_price, reduced_price, ship_id) VALUES
(NULL, 'Around the World Autumn 2014', TO_DATE('17/09/2014', 'DD/MM/YYYY'), TO_DATE('18/10/2014', 'DD/MM/YYYY'), 6600, NULL, 24);
...
-- rooms does it currently have booked for its service of the package 'Asian Adventure Summer 2014'?
...
WHILE cur_room%FOUND AND total_qty >= 1 LOOP
	...
	ELSIF total_qty <= 8 AND total_qty > 5 then
		IF room_row.reservation_id IS NULL AND room_row.room_type = 'penthouse suite' THEN
		assignRoom(room_Row.room_id, reserv_num);
		total_qty := total_qty - 2;
		ELSIF room_row.reservation_id IS NULL AND room_row.room_type = 'junior suite' THEN 
...
SELECT TotalRevenueFromPkg(2) FROM dual;
